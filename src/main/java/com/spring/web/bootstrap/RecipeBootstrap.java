...
import com.spring.web.domain.Difficulty;
import com.spring.web.domain.Ingredient;
import com.spring.web.domain.Notes;
import com.spring.web.domain.Recipe;
import com.spring.web.domain.UnitOfMeasure;
import com.spring.web.repositories.CategoryRepository;
import com.spring.web.repositories.RecipeRepository;
import com.spring.web.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Indian");
